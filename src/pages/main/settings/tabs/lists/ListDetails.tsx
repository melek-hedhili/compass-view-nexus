        ...
        {selectedList && (
          <div className="p-6 space-y-6">
            <div>
              ...
              <p className="text-sm font-normal">{selectedList.fieldName}</p>
            </div>
              ...
              <div className="flex flex-wrap gap-2">
                {selectedList.values?.map((value, index) => (
                  <Badge
                    key={index}
                    variant="outline"
                    className="bg-gray-100 text-gray-700 hover:bg-gray-100 text-sm font-normal"
                  >
                    {value}
                  </Badge>
                ))}
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">{selectedList._id}</p>
            </div>
