...
import InformationsSection from "./Tabs/Informations/InformationsSection";
import DocumentsSection from "./Tabs/Documents/DocumentsSection";
import AnalyseSection from "./Tabs/Analyse/AnalyseSection";
import RapportSection from "./Tabs/Rapport/RapportSection";
import AnnonceSection from "./Tabs/Annonce/AnnonceSection";
import SaisieSection from "./Tabs/Saisie/SaisieSection";
import ControleSection from "./Tabs/Controle/ControleSection";
import MailsSection from "./Tabs/Mails/MailsSection";
...
const DossierDetail = ({ dossierId, onClose }: DossierDetailProps) => {
  ...
  const requiredDocumentsPercent = 25;
  return (
        ...
        <div className="flex justify-between items-center py-2">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-medium">
              Dossiers &gt; Création - Chocolat & Co (Cabinet MAZARS)
            </h1>
          </div>
        </div>
      </div>
