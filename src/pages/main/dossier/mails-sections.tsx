...
import { ImageIcon, FileText, Paperclip, X } from "lucide-react"
...
export default function MailsSection({ dossierId }: MailsSectionProps) {
  ...
  const [newAttachments, setNewAttachments] = useState<string[]>(["carte_vitale.png", "statuts_constitutifs.pdf"])
  ...
  const selectedEmail = [...receivedEmails, ...sentEmails].find((email) => email.id === selectedEmailId)
  ...
  const addAttachment = () => {
    ...
    alert("Cette fonctionnalité ouvrirait un sélecteur de fichier dans une application réelle.")
  }
  ...
  return (
    <div className="space-y-4">
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-100">
                    ...
                    <TableHead className="font-medium text-center">PJ</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {receivedEmails.map((email) => (
                    ...
                    >
                      ...
                      <TableCell className="align-top">{email.date}</TableCell>
              ...
              {selectedEmail && (
                <>
                  <div className="border-b p-4">
                    <div>
                      <div className="text-sm text-gray-500 mb-1">Pièces jointes</div>
                  ...
                  <div className="p-4">
                    <h3 className="text-xl font-medium mb-6">{selectedEmail.subject}</h3>
                    <div className="text-sm text-gray-600 whitespace-pre-line">{selectedEmail.content}</div>
                  </div>
                </>
              )}
            </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-[100px_1fr] gap-4 items-center">
              ...
              <div className="flex gap-2 items-center">
                <Input className="flex-1" placeholder="Adresse email du destinataire" />
                <Select>
            ...
            <div className="grid grid-cols-[100px_1fr] gap-4 items-start">
              ...
              <Textarea className="min-h-[300px]" placeholder="Contenu de l'email..." />
            </div>
      ...
      <Dialog open={!!selectedAttachment} onOpenChange={() => closeAttachmentDetails()}>
        <DialogContent className="sm:max-w-[600px]">
          ...
          {selectedAttachment && (
            <div className="space-y-4">
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm font-medium text-gray-500">Type de fichier</p>
              ...
              {selectedAttachment.preview && selectedAttachment.type.startsWith("image/") && (
                <div className="mt-4">
                  <p className="text-sm font-medium text-gray-500 mb-2">Aperçu</p>
