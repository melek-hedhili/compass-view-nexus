...
export default function InformationsSection({ dossierId }: InformationsSectionProps) {
  ...
  const requiredDocuments = [
    ...
    { id: "attestation-domiciliation", name: "Attestation de domiciliation", status: "pending" },
    ...
    { id: "justificatif-domicile", name: "Justificatif de domicile", status: "pending" },
      ...
      <div className="flex justify-between items-start">
        <div className="w-1/2 pr-4">
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-50">
                  ...
                  <TableHead className="font-medium text-center">Manquant</TableHead>
                  <TableHead className="font-medium text-center">À normaliser</TableHead>
                  <TableHead className="font-medium text-center">Validé</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {fileStatus.map((item) => (
                  <TableRow key={item.category} className="bg-white">
                    ...
                    <TableCell className="text-center">{item.total - item.pending - item.validated}</TableCell>
                    <TableCell className="text-center">{item.pending}</TableCell>
                    <TableCell className="text-center">{item.validated}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
          ...
          <Card className="border rounded-lg overflow-hidden">
            <div className="bg-gray-100 p-3 font-medium">Informations générales</div>
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-[150px_1fr] items-center">
                ...
                <Select defaultValue="journal-officiel">
                  ...
                  <SelectContent>
                    <SelectItem value="journal-officiel">Journal Officiel</SelectItem>
        ...
        <div className="w-1/2 pl-4">
          ...
          <Card className="border rounded-lg overflow-hidden">
            <div className="bg-gray-100 p-3 font-medium">Documents nécessaires pour le dossier</div>
            <Table>
              <TableBody>
