...
export default function ControleAnalyseSection({ dossierId }: ControleAnalyseSectionProps) {
  return (
    <>
      {/* Lecture IA Section */}
        ...
        <div className="p-4 border-b bg-gray-50">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray-500">2 documents à analyser</span>
      ...
      <div className="flex gap-6">
        <div className="w-1/2">
          ...
          <Card className="border rounded-lg overflow-hidden mb-6">
            ...
            <div className="bg-gray-50 p-4 border-b">
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-2">
                  <h4 className="font-medium">Conférence des dates des statuts</h4>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="outline" size="sm" className="h-7 px-3 bg-orange-100">
                    -
                  </Button>
                  <Button variant="outline" size="sm" className="h-7 px-3 bg-green-100">
                    OUI
                  </Button>
                </div>
              </div>
              <p className="text-xs text-gray-600 mb-3">
                La date présente dans les statuts doit être conforme à celle présente dans la liste des bénéficiaires
                effectifs.
              </p>

              <div className="grid grid-cols-2 gap-2 bg-white p-2 border rounded">
                <div>
                  <div className="text-xs text-gray-500">Statut constitutif</div>
                  <div className="text-sm">15/12/2024</div>
                </div>
                <div>
                  <div className="text-xs text-gray-500">Liste des bénéficiaires</div>
                  <div className="text-sm">15/12/2024</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-4 border-b">
              ...
              <p className="text-xs text-gray-600">
                Les signatures doivent être présentes sur les documents suivants:
                <br />
          ...
          <Card className="border rounded-lg overflow-hidden">
            <div className="p-3 bg-gray-100 border-b">
              <h3 className="font-medium uppercase">Liste des bénéficiaires effectifs</h3>
            </div>

            <div className="bg-gray-50 p-4 border-b">
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-2">
                  <h4 className="font-medium">Présence de la clause de succession</h4>
                  <ChevronDown className="h-4 w-4" />
                </div>
                <div className="flex items-center gap-2">
                  <Button variant="outline" size="sm" className="h-7 px-3">
              ...
              <div className="bg-white p-3 border rounded text-xs text-gray-700">
                <p>
                  "Tous tous les actes et documents émanant de la Société, la dénomination sociale doit être précédée ou
                ...
                <p className="mt-2">
                  ...
                  publicitaires, ainsi que sur toutes correspondances et récépissés concernant son activité et signés
                  par elle ou en son nom, le siège du tribunal au greffe duquel elle est immatriculée au Registre du
                  commerce et des sociétés, et le numéro d'immatriculation qu'elle a reçu."
                </p>
              </div>
            </div>
