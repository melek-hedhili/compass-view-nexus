...
import { ChevronLeft, ChevronRight, Upload, Copy, Lock } from 'lucide-react'
        ...
        {sections.map((section, index) => (
          <Button
            ...
            className={`px-4 py-2 rounded-none ${
              currentPage === index ? "border-b-2 border-formality-primary text-formality-primary" : "text-gray-600"
            }`}
          ...
          {currentPage === 1 && (
            <div className="space-y-6">
              ...
              <Card className="p-6 border rounded-lg">
                ...
                <div className="flex items-center gap-4">
                  <Input className="max-w-xs" type="password" placeholder="Mot de passe" />
                  <Button variant="outline" size="sm" className="flex items-center gap-1">
                    <Copy className="h-4 w-4" /> Copier
                  </Button>
                </div>
              ...
              <Card className="p-6 border rounded-lg">
                <h3 className="font-medium mb-4 text-lg">Informations de publication</h3>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="flex-1">
                      <Input className="max-w-xs" placeholder="N° de publication" />
                    </div>
                  </div>
                  <div className="flex items-center">
            ...
            <div className="p-4 h-[600px] overflow-auto">
              <div className="space-y-4">
                <div className="text-sm">
                  ...
                  <div className="bg-gray-50 p-2 rounded border">Journal Officiel</div>
                </div>
                ...
                <div className="text-sm">
                  ...
                  <div className="bg-gray-50 p-2 rounded border whitespace-pre-line font-mono text-xs">
                    Par acte SSP du 15/12/2024 il a été constitué une SARL dénommée: CHOCOLAT & CO
                    Siège social: 25 rue des Lilas 75001 PARIS
                    Capital: 10.000€
                    Objet: Fabrication et commercialisation de denrées alimentaires périssables
                    Gérant: M. DUPONT Jean, 12 avenue Victor Hugo 75016 PARIS
