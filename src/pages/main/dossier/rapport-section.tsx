      ...
      <div className="w-1/2">
        <div className="space-y-6">
          ...
          <div className="border-t pt-4">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => setShowSignatureDetails(!showSignatureDetails)} className="focus:outline-none">
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${showSignatureDetails ? "transform rotate-180" : ""}`}
                  />
                </button>
              </div>
              <div className="flex items-center gap-2">
                <Button variant="outline" size="sm" className="h-7 px-3 border-gray-300">
                  NON
                </Button>
                <Button variant="outline" size="sm" className="h-7 px-3 bg-orange-100 border-orange-300">
                  -
                </Button>
                <Button variant="outline" size="sm" className="h-7 px-3 bg-green-100 border-green-300">
                  OUI
                </Button>
              </div>
            </div>
            ...
            {showSignatureDetails && (
              <div className="bg-gray-100 p-3 rounded text-sm">
                <p className="text-gray-700">Les signatures doivent être présentes sur les documents suivants:</p>
          ...
          <div className="border-t pt-4">
            ...
            <div className="border rounded-md overflow-hidden">
              ...
              <div className="flex items-center justify-between p-2 bg-white">
                <span className="text-sm">Liste des bénéficiaires effectifs</span>
                <div className="flex h-5 w-5 items-center justify-center rounded-full bg-orange-400 text-white">
                  <span className="text-xs">!</span>
                </div>
              </div>
          ...
          <div className="flex justify-between items-center pt-4">
            <Button variant="outline" size="icon" className="rounded-md border-gray-800">
              <svg
            ...
            <Button className="bg-gray-200 text-gray-800 hover:bg-gray-300">Valider le dossier</Button>
          </div>
        </div>
      </div>
