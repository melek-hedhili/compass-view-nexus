      ...
      <div className="layout-container py-6 animate-enter">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <h1 className="text-2xl font-bold text-formality-accent">Gestion des projets</h1>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projectsData.map((project) => (
            <Card key={project.id} className="card-elegant overflow-hidden border-none transition-all hover:shadow-md">
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-formality-primary font-medium">{project.progress}%</span>
                </div>
